				  ...
				  <div class="main2left">
					  <div id="pai">
					  	...
					  	<ul>
							...
							<div v-if="item.fufenlei===fufenlei" style="display: flex; justify-content: space-between;">
					  			<div style="color: #262626; ">{{item.bookname}}</div><br>
					  			<div >{{item.writer}}</div>
							</div>
					  		</li>
					  	</ul>
				  ...
				  <div class="main2mid">
					  <div class="booklist" >
						  <div class="books" v-for="(item,index) in zifenleimesg" :key="index" @click="godetail(item)">
							<div v-if="item.fufenlei===fufenlei">
		...
		methods:{
			handleClick(e) {
					...
					        res => {
							...
							console.log('123'+this.zifenleimesg);
