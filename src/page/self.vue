			...
			<div class="shujialist">
				...
				<el-table
				  ...
				  :show-overflow-tooltip="true"
				    label="书名/最近更新章节"
					prop="fenlei,bookname,zhangjie,title"
				    width="280">
				    <template slot-scope="scope" >【{{ scope.row.fenlei }}】 {{scope.row.bookname}} &nbsp; &nbsp;  {{scope.row.zhangjie}} &nbsp; {{scope.row.title}}</template>
				  </el-table-column>
				  <el-table-column
				    prop="time"
				    label="更新时间"
