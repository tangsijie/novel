    ...
    <div class="contain">
      ...
      <div class="small-box" :class="{ active: isLogin }">
        <div class="small-contain" v-if="isLogin">
          <div class="stitle" @click="home1" style="cursor: pointer;">
            回去首页!
          </div>
...
export default {
  ...
  methods: {
    ...
    register() {
      if (
        this.lispassword == this.lispassword2 &&
        this.lisaccount != "" &&
        this.lispassword != ""
      ) {
        axios({
          ...
          data: {
            rname: this.lisaccount,
            rpwd: this.lispassword,
            status: this.lcount,
    ...
    login() {
      axios({
        ...
        data: {
          rname: this.isaccount,
          rpwd: this.ispassword,
          status: this.count
        }
      }).then(
        (res) => {
          console.dir('data::',res.data.data);
